...
public class NambaFood extends BaseTest {
    ...
    void orderFood() throws InterruptedException {
        ...
        sushiFood.click();
        WebElement freshBox= driver.findElement(By.xpath("//div[@class='catalog-wrap']/a[15]"));
        freshBox.click();
        WebElement plusRhiladelfiya= driver.findElement(By.xpath("//div[@data-item-id='43861']/div[2]/div[2]"));
...
//        WebElement plusSushiritto= driver.findElement(By.xpath("//div[@data-item-id='260377']/div[2]/div[2]"));
//        plusSushiritto.click();
//        plusSushiritto.click();
//        plusSushiritto.click();
//        WebElement orderSushiritto= driver.findElement(By.xpath("//div[@data-item-id='260377']/button"));
